...
func (o *FlagResponse) GetAdd() []string {
...
func (o *FlagResponse) GetAddOk() ([]string, bool) {
	if o == nil || IsNil(o.Add) {
		return nil, false
	}
	return o.Add, true
...
func (o *FlagResponse) HasAdd() bool {
	if o != nil && !IsNil(o.Add) {
		return true
	}
...
func (o *FlagResponse) SetAdd(v []string) {
	o.Add = v
}

// GetDelete returns the Delete field value if set, zero value otherwise.
func (o *FlagResponse) GetDelete() []string {
...
// and a boolean to check if the value has been set.
func (o *FlagResponse) GetDeleteOk() ([]string, bool) {
	if o == nil || IsNil(o.Delete) {
		return nil, false
	}
...
func (o *FlagResponse) HasDelete() bool {
	if o != nil && !IsNil(o.Delete) {
		return true
	}
...
func (o *FlagResponse) SetDelete(v []string) {
	o.Delete = v
}

// GetSet returns the Set field value if set, zero value otherwise.
func (o *FlagResponse) GetSet() []string {
...
// and a boolean to check if the value has been set.
func (o *FlagResponse) GetSetOk() ([]string, bool) {
	if o == nil || IsNil(o.Set) {
		return nil, false
	}
	return o.Set, true
...
func (o *FlagResponse) HasSet() bool {
	if o != nil && !IsNil(o.Set) {
		return true
	}
...
func (o *FlagResponse) SetSet(v []string) {
	o.Set = v
}
