...
// checks if the RequestReconnect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestReconnect{}

// RequestReconnect struct for RequestReconnect
type RequestReconnect struct {
	// Only reconnect if true
	Reconnect *bool `json:"reconnect,omitempty"`
}

// NewRequestReconnect instantiates a new RequestReconnect object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRequestReconnect() *RequestReconnect {
...
// NewRequestReconnectWithDefaults instantiates a new RequestReconnect object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRequestReconnectWithDefaults() *RequestReconnect {
	this := RequestReconnect{}
	var reconnect bool = false
	this.Reconnect = &reconnect
	return &this
...
func (o *RequestReconnect) GetReconnect() bool {
...
func (o *RequestReconnect) GetReconnectOk() (*bool, bool) {
	if o == nil || IsNil(o.Reconnect) {
		return nil, false
	}
...
func (o *RequestReconnect) HasReconnect() bool {
	if o != nil && !IsNil(o.Reconnect) {
		return true
	}
...
func (o *RequestReconnect) SetReconnect(v bool) {
	o.Reconnect = &v
}

func (o RequestReconnect) MarshalJSON() ([]byte, error) {
...
func (o RequestReconnect) ToMap() (map[string]interface{}, error) {
...
type NullableRequestReconnect struct {
	value *RequestReconnect
	isSet bool
}

func (v NullableRequestReconnect) Get() *RequestReconnect {
	return v.value
}

func (v *NullableRequestReconnect) Set(val *RequestReconnect) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestReconnect) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestReconnect) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestReconnect(val *RequestReconnect) *NullableRequestReconnect {
	return &NullableRequestReconnect{value: val, isSet: true}
}

func (v NullableRequestReconnect) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestReconnect) UnmarshalJSON(src []byte) error {
	v.isSet = true
