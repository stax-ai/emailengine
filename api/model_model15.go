...
// checks if the Model15 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Model15{}

// Model15 Advanced TLS configuration options
type Model15 struct {
...
func (o Model15) MarshalJSON() ([]byte, error) {
...
func (o Model15) ToMap() (map[string]interface{}, error) {
...
type NullableModel15 struct {
	value *Model15
	isSet bool
}

func (v NullableModel15) Get() *Model15 {
	return v.value
}

func (v *NullableModel15) Set(val *Model15) {
	v.value = val
	v.isSet = true
}

func (v NullableModel15) IsSet() bool {
	return v.isSet
}

func (v *NullableModel15) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModel15(val *Model15) *NullableModel15 {
	return &NullableModel15{value: val, isSet: true}
}

func (v NullableModel15) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModel15) UnmarshalJSON(src []byte) error {
	v.isSet = true
