...
// checks if the LabelUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelUpdate{}

// LabelUpdate Label operations to perform (Gmail only)
...
func (o LabelUpdate) MarshalJSON() ([]byte, error) {
...
func (o LabelUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableLabelUpdate struct {
	value *LabelUpdate
	isSet bool
}

func (v NullableLabelUpdate) Get() *LabelUpdate {
	return v.value
}

func (v *NullableLabelUpdate) Set(val *LabelUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableLabelUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableLabelUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLabelUpdate(val *LabelUpdate) *NullableLabelUpdate {
	return &NullableLabelUpdate{value: val, isSet: true}
}

func (v NullableLabelUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLabelUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
