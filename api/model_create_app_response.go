...
// checks if the CreateAppResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAppResponse{}

// CreateAppResponse struct for CreateAppResponse
...
type _CreateAppResponse CreateAppResponse
...
func (o CreateAppResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAppResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAppResponse := _CreateAppResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAppResponse)

	if err != nil {
		return err
	}

	*o = CreateAppResponse(varCreateAppResponse)

	return err
}

type NullableCreateAppResponse struct {
	value *CreateAppResponse
	isSet bool
}

func (v NullableCreateAppResponse) Get() *CreateAppResponse {
	return v.value
}

func (v *NullableCreateAppResponse) Set(val *CreateAppResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAppResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAppResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAppResponse(val *CreateAppResponse) *NullableCreateAppResponse {
	return &NullableCreateAppResponse{value: val, isSet: true}
}

func (v NullableCreateAppResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAppResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
