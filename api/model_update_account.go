...
type UpdateAccount struct {
	...
	Imap *IMAPUpdate `json:"imap,omitempty"`
	// Optional locale
	...
	Oauth2 *OAuth2Update `json:"oauth2,omitempty"`
...
func (o *UpdateAccount) SetCopyNil() {
	o.Copy.Set(nil)
}
...
// SetImap gets a reference to the given IMAPUpdate and assigns it to the Imap field.
...
func (o *UpdateAccount) SetNotifyFromNil() {
...
// SetOauth2 gets a reference to the given OAuth2Update and assigns it to the Oauth2 field.
...
// SetSmtp gets a reference to the given SMTPUpdate and assigns it to the Smtp field.
...
func (o *UpdateAccount) SetSmtpEhloNameNil() {
