...
// checks if the ReplyToAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplyToAddress{}

// ReplyToAddress Email address with optional display name
type ReplyToAddress struct {
	// Email address
...
type _ReplyToAddress ReplyToAddress
...
func (o ReplyToAddress) MarshalJSON() ([]byte, error) {
...
func (o ReplyToAddress) ToMap() (map[string]interface{}, error) {
...
func (o *ReplyToAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varReplyToAddress := _ReplyToAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReplyToAddress)

	if err != nil {
		return err
	}

	*o = ReplyToAddress(varReplyToAddress)

	return err
}

type NullableReplyToAddress struct {
	value *ReplyToAddress
	isSet bool
}

func (v NullableReplyToAddress) Get() *ReplyToAddress {
	return v.value
}

func (v *NullableReplyToAddress) Set(val *ReplyToAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableReplyToAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableReplyToAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplyToAddress(val *ReplyToAddress) *NullableReplyToAddress {
	return &NullableReplyToAddress{value: val, isSet: true}
}

func (v NullableReplyToAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReplyToAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
