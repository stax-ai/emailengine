...
// checks if the WebhookRoutesListEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookRoutesListEntry{}

// WebhookRoutesListEntry struct for WebhookRoutesListEntry
type WebhookRoutesListEntry struct {
...
type _WebhookRoutesListEntry WebhookRoutesListEntry
...
func (o WebhookRoutesListEntry) MarshalJSON() ([]byte, error) {
...
func (o WebhookRoutesListEntry) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookRoutesListEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookRoutesListEntry := _WebhookRoutesListEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookRoutesListEntry)

	if err != nil {
		return err
	}

	*o = WebhookRoutesListEntry(varWebhookRoutesListEntry)

	return err
}

type NullableWebhookRoutesListEntry struct {
	value *WebhookRoutesListEntry
	isSet bool
}

func (v NullableWebhookRoutesListEntry) Get() *WebhookRoutesListEntry {
	return v.value
}

func (v *NullableWebhookRoutesListEntry) Set(val *WebhookRoutesListEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookRoutesListEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookRoutesListEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookRoutesListEntry(val *WebhookRoutesListEntry) *NullableWebhookRoutesListEntry {
	return &NullableWebhookRoutesListEntry{value: val, isSet: true}
}

func (v NullableWebhookRoutesListEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookRoutesListEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
