...
// checks if the BccAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BccAddress{}

// BccAddress Email address with optional display name
type BccAddress struct {
	// Email address
...
func (o BccAddress) MarshalJSON() ([]byte, error) {
...
func (o BccAddress) ToMap() (map[string]interface{}, error) {
...
func (o *BccAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varBccAddress := _BccAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBccAddress)

	if err != nil {
		return err
	}

	*o = BccAddress(varBccAddress)

	return err
}

type NullableBccAddress struct {
	value *BccAddress
	isSet bool
}

func (v NullableBccAddress) Get() *BccAddress {
	return v.value
}

func (v *NullableBccAddress) Set(val *BccAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableBccAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableBccAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBccAddress(val *BccAddress) *NullableBccAddress {
	return &NullableBccAddress{value: val, isSet: true}
}

func (v NullableBccAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBccAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
