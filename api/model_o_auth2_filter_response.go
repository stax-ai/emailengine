...
// checks if the OAuth2FilterResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuth2FilterResponse{}

// OAuth2FilterResponse struct for OAuth2FilterResponse
type OAuth2FilterResponse struct {
	Apps []OAuth2ResponseItem `json:"apps,omitempty"`
...
// SetApps gets a reference to the given []OAuth2ResponseItem and assigns it to the Apps field.
...
func (o OAuth2FilterResponse) MarshalJSON() ([]byte, error) {
...
func (o OAuth2FilterResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOAuth2FilterResponse struct {
	value *OAuth2FilterResponse
	isSet bool
}

func (v NullableOAuth2FilterResponse) Get() *OAuth2FilterResponse {
	return v.value
}

func (v *NullableOAuth2FilterResponse) Set(val *OAuth2FilterResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuth2FilterResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuth2FilterResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuth2FilterResponse(val *OAuth2FilterResponse) *NullableOAuth2FilterResponse {
	return &NullableOAuth2FilterResponse{value: val, isSet: true}
}

func (v NullableOAuth2FilterResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuth2FilterResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
