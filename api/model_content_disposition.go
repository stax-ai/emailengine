...
// ContentDisposition the model 'ContentDisposition'
type ContentDisposition string

// List of contentDisposition
const (
	CONTENTDISPOSITION_INLINE ContentDisposition = "inline"
	CONTENTDISPOSITION_ATTACHMENT ContentDisposition = "attachment"
)

// All allowed values of ContentDisposition enum
var AllowedContentDispositionEnumValues = []ContentDisposition{
	"inline",
	"attachment",
}

func (v *ContentDisposition) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ContentDisposition(value)
	for _, existing := range AllowedContentDispositionEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ContentDisposition", value)
}

// NewContentDispositionFromValue returns a pointer to a valid ContentDisposition
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewContentDispositionFromValue(v string) (*ContentDisposition, error) {
	ev := ContentDisposition(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ContentDisposition: valid values are %v", v, AllowedContentDispositionEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ContentDisposition) IsValid() bool {
	for _, existing := range AllowedContentDispositionEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to contentDisposition value
func (v ContentDisposition) Ptr() *ContentDisposition {
	return &v
}
