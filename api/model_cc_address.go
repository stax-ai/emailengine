...
// checks if the CcAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CcAddress{}

// CcAddress Email address with optional display name
...
func (o CcAddress) MarshalJSON() ([]byte, error) {
...
func (o CcAddress) ToMap() (map[string]interface{}, error) {
...
func (o *CcAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varCcAddress := _CcAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCcAddress)

	if err != nil {
		return err
	}

	*o = CcAddress(varCcAddress)

	return err
}

type NullableCcAddress struct {
	value *CcAddress
	isSet bool
}

func (v NullableCcAddress) Get() *CcAddress {
	return v.value
}

func (v *NullableCcAddress) Set(val *CcAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableCcAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableCcAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcAddress(val *CcAddress) *NullableCcAddress {
	return &NullableCcAddress{value: val, isSet: true}
}

func (v NullableCcAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCcAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
