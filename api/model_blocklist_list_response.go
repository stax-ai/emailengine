...
// checks if the BlocklistListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlocklistListResponse{}

// BlocklistListResponse struct for BlocklistListResponse
type BlocklistListResponse struct {
	Addresses []BlocklistListResponseItem `json:"addresses,omitempty"`
	// List ID
...
type _BlocklistListResponse BlocklistListResponse
...
func (o *BlocklistListResponse) GetAddresses() []BlocklistListResponseItem {
	if o == nil || IsNil(o.Addresses) {
		var ret []BlocklistListResponseItem
		return ret
	}
	return o.Addresses
}
...
// SetAddresses gets a reference to the given []BlocklistListResponseItem and assigns it to the Addresses field.
...
func (o BlocklistListResponse) MarshalJSON() ([]byte, error) {
...
func (o BlocklistListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BlocklistListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBlocklistListResponse := _BlocklistListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBlocklistListResponse)

	if err != nil {
		return err
	}

	*o = BlocklistListResponse(varBlocklistListResponse)

	return err
}

type NullableBlocklistListResponse struct {
	value *BlocklistListResponse
	isSet bool
}

func (v NullableBlocklistListResponse) Get() *BlocklistListResponse {
	return v.value
}

func (v *NullableBlocklistListResponse) Set(val *BlocklistListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlocklistListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlocklistListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlocklistListResponse(val *BlocklistListResponse) *NullableBlocklistListResponse {
	return &NullableBlocklistListResponse{value: val, isSet: true}
}

func (v NullableBlocklistListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlocklistListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
